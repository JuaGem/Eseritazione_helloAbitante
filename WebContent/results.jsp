...
<body>
	<table class="center">
		...
		<tr>
			...
			<td><a
				...
				<a
				href="PrepareModificaAbitanteServlet?idDaInviareComeParametro=<%=abitanteItem.getIdAbitante() %>">Modifica</a>
				<a
				href="PrepareDeleteAbitanteServlet?idDaInviareComeParametro=<%=abitanteItem.getIdAbitante() %>">Elimina</a>
			</td>
		</tr>
		<%	}%>
	...
	<a href="PrepareInsertAbitanteServlet"> Aggiungi nuovo abitante</a>
